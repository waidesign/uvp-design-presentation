    ...
    <div className="min-h-screen flex flex-col bg-[#F5FDF9]">
      ...
      <main className="flex-grow flex items-center justify-center py-20 px-6">
        <div className="text-center">
          <h1 
            style={{ fontFamily: '"Gochi Hand", cursive', fontSize: 'clamp(3rem, 8vw, 6rem)', color: '#111827' }}
            className="mb-4"
          >
            404
          </h1>
          <h2 
            style={{ fontFamily: '"Gochi Hand", cursive', fontSize: 'clamp(1.5rem, 4vw, 2.5rem)', color: '#0EB075' }}
            className="mb-8"
          >
